import type {ConcreteSnapshotOptions, Page, PageList, SnapshotOptions} from '@types';
...
export default class Crawler {
    ...
    private readonly options: ConcreteSnapshotOptions;
    ...
    private mergeOptions(options: SnapshotOptions): ConcreteSnapshotOptions {
        const defaultOnEvent = (msg: string) => console.log(msg);
        return {
